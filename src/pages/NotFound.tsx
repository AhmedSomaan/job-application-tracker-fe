import cat from "../assets/ConfusedCat.png";

const NotFound = () => {
  return (
    <div>
      <main className="flex h-full min-h-screen grow flex-col items-center justify-center gap-8">
        <h1 className="mb-8 text-2xl font-medium sm:text-4xl md:text-5xl">
          Error: 404 - Page Not Found
        </h1>
        <img
          className=" w-[10rem] sm:w-[15rem] md:w-[25rem]"
          src={cat}
          alt=""
        />
        <a
          className="hover:bg-green flex items-center gap-4 rounded-xl bg-light-grey p-4 px-8 text-xl hover:font-medium hover:text-dark-grey md:text-2xl"
          href="/"
        >
          GO HOME{" "}
          <svg
